...
Si el puerto `8000` está ocupado, el servidor prueba automáticamente `8001`, `8002`, etc. (hasta 10 intentos), y te muestra en consola cuál quedó activo.

También puedes forzar un puerto:
